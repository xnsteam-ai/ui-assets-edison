 ...
 *
 * The Prisma name and logo are trademarks of their respective owner, reproduced here to
...
function LogoPrisma({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 256 310"
      role="img"
