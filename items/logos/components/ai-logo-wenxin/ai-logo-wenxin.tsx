 ...
 *
 * The Wenxin name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoWenxin({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      ...
      <defs>
      <linearGradient id="wenxin-lobe-icons-wenxin-_R_0_" x1="9.155%" x2="90.531%" y1="75.177%" y2="25.028%">
