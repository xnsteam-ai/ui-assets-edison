 ...
 *
 * The jimeng name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoJimeng({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
      ...
      {...props}
    >
      <g clipPath="url(#jimeng-lobe-icons-jimeng-0-_R_0_)">
      <g transform="matrix(-0.009271 -0.017448 0.0215011 -0.0134883 13.0472 18.2292)">
      <rect fill="url(#jimeng-lobe-icons-jimeng-1-_R_0_)" height="666.506" opacity="1" shapeRendering="crispEdges" width="1077.71" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-1-_R_0_)" height="666.506" opacity="1" shapeRendering="crispEdges" transform="scale(1 -1)" width="1077.71" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-1-_R_0_)" height="666.506" opacity="1" shapeRendering="crispEdges" transform="scale(-1 1)" width="1077.71" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-1-_R_0_)" height="666.506" opacity="1" shapeRendering="crispEdges" transform="scale(-1)" width="1077.71" x="0" y="0">
      </rect>
      </g>
      </g>
      <g clipPath="url(#jimeng-lobe-icons-jimeng-2-_R_0_)">
      <g transform="matrix(-0.00282575 -0.00489434 0.00971874 -0.00561112 16.5909 23.2227)">
      <rect fill="url(#jimeng-lobe-icons-jimeng-3-_R_0_)" height="1485.61" opacity="1" shapeRendering="crispEdges" width="4828.03" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-3-_R_0_)" height="1485.61" opacity="1" shapeRendering="crispEdges" transform="scale(1 -1)" width="4828.03" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-3-_R_0_)" height="1485.61" opacity="1" shapeRendering="crispEdges" transform="scale(-1 1)" width="4828.03" x="0" y="0">
      </rect>
      <rect fill="url(#jimeng-lobe-icons-jimeng-3-_R_0_)" height="1485.61" opacity="1" shapeRendering="crispEdges" transform="scale(-1)" width="4828.03" x="0" y="0">
      </rect>
      </g>
      </g>
      <defs>
      <clipPath id="jimeng-lobe-icons-jimeng-0-_R_0_">
      ...
      <clipPath id="jimeng-lobe-icons-jimeng-2-_R_0_">
      ...
      <linearGradient gradientUnits="userSpaceOnUse" id="jimeng-lobe-icons-jimeng-1-_R_0_" x1="0" x2="500" y1="0" y2="500">
      ...
      <linearGradient gradientUnits="userSpaceOnUse" id="jimeng-lobe-icons-jimeng-3-_R_0_" x1="0" x2="500" y1="0" y2="500">
