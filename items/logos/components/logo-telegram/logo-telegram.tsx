 ...
 *
 * The Telegram name and logo are trademarks of their respective owner, reproduced here to
...
function LogoTelegram({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 256 256"
      role="img"
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="2.77555756e-15%" x2="50%" y2="100%" id="telegram-telegramLinearGradient-1">
