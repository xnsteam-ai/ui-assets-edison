 ...
 *
 * The Apple name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoApple({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
