 ...
 *
 * The rwkv name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoRwkv({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      <defs>
      <linearGradient id="rwkv-lobe-icons-rwkv-_R_0_" x1="100%" x2="0%" y1="53.893%" y2="53.893%">
