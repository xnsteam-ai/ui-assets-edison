 ...
 *
 * The bocha name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoBocha({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      ...
      <path d="M3.726 7.575l2.921 5.847.161 2.05a.114.114 0 01-.01.055l-.012.027L.02 8.821a.07.07 0 01.001-.1C1.064 7.747 2.3 7.365 3.726 7.576z" fill="#A5CCFF" fillOpacity=".647">
      </path>
    </svg>
  );
}
