 ...
 *
 * The chatglm name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoChatglm({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      <defs>
      <linearGradient id="chatglm-lobe-icons-chat-glm-_R_0_" x1="-18.756%" x2="70.894%" y1="49.371%" y2="90.944%">
