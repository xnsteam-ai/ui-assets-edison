 ...
 *
 * The cybercut name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoCybercut({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      ...
      <defs>
      <linearGradient gradientUnits="userSpaceOnUse" id="cybercut-b" x1="9.608" x2="25.856" y1="12.343" y2="12.343">
      <stop>
      </stop>
