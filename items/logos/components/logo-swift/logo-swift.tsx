 ...
 *
 * The Swift name and logo are trademarks of their respective owner, reproduced here to
...
function LogoSwift({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 256 256"
      role="img"
