 ...
 *
 * The Targon name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoTargon({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 25 25"
      role="img"
