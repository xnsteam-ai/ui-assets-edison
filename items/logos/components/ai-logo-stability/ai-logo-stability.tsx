 ...
 *
 * The Stability name and logo are trademarks of their respective owner, reproduced here to identify
...
function AiLogoStability({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
    ...
    >
      ...
      <defs>
      <linearGradient id="stability-lobe-icons-stability-_R_0_" x1="50%" x2="50%" y1="0%" y2="100%">
