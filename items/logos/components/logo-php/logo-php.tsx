 ...
 *
 * The PHP name and logo are trademarks of their respective owner, reproduced here to
...
function LogoPhp({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 256 135"
      role="img"
    ...
    >
      <defs>
		<radialGradient id="php-radialGradient-1" cx="0.8366" cy="-125.811" r="363.0565" gradientTransform="matrix(0.463 0 0 0.463 76.4644 81.9182)" gradientUnits="userSpaceOnUse">
	...
	<g>
		<ellipse fill="url(#php-radialGradient-1)" cx="128" cy="67.3" rx="128" ry="67.3"/>
