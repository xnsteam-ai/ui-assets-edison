...
function IconBatteryMedium01({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
      aria-label="Battery Medium 01 icon"
      fill="none"
    ...
    >
      ...
      <path d="M6 10V14" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
      <path d="M9 10V14" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
    </svg>
  );
}

export { IconBatteryMedium01 };
