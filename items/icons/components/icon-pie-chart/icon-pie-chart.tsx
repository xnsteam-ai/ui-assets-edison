...
function IconPieChart({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.5 15.8278C17.9985 21.756 9.86407 23.4835 5.20143 18.8641C0.629484 14.3347 2.04493 6.12883 8.05653 3.5" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
