...
function IconSidebarRight({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
      aria-label="Sidebar Right icon"
      fill="none"
    ...
    >
      ...
      <path d="M14.5 3.00003L14.5 21" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M18 7.00006H19M18 10.0001H19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
}

export { IconSidebarRight };
